...
| `statements[]`<br/>`.condition["conditionType"]["conditionKey"]` | any                | undefined | `false`  | The **_conditionKey_** should be a custom string path attribute for a specific context attribute.<br/> Note: attributes must be separated but dots (`.`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
